...
return AuthService.isCurrentUserProjectOwner(projectOwnerId);
 };

const canAssignIssue = (issue) => {
return AuthService.canAssignIssue(issue);
 };

const canUpdateIssueStatus = (issue) => {
return AuthService.canUpdateIssueStatus(issue);
 };
