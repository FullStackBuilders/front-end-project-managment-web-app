        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={configRef}>
            <button
              ...
              aria-label="Configure optional cards"
            ...
            {configOpen && (
              <div className="absolute left-0 top-full mt-1.5 z-20 w-52 bg-white border border-gray-200 rounded-lg shadow-lg py-1">
                <p className="px-3 pt-2 pb-1.5 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                  Customize Task Summary
                </p>
                ...
                {OPTIONAL_CARDS.map((card) => (
                  ...
                  >
                    <input
                      ...
                      className="w-3.5 h-3.5 rounded border-gray-300 text-primary accent-blue-600 cursor-pointer"
                    />
